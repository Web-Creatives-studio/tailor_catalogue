      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-extrabold text-slate-800 text-base">Record Client Measurement</h2>
              <p className="text-[11px] text-slate-500">Store precise fit parameters for your client</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="p-5 border-t border-slate-100 bg-white flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={handleClose}
            className="px-5 py-2.5 rounded-xl border border-slate-300 text-slate-600 font-semibold text-xs hover:bg-slate-50 transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            disabled={saving}
            className="px-6 py-2.5 rounded-xl bg-[#128C7E] hover:bg-[#0e6d62] text-white font-bold text-xs shadow-md transition-all active:scale-[0.98] disabled:opacity-50"
          >
